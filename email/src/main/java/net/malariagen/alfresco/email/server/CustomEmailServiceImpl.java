package net.malariagen.alfresco.email.server;
 ...
 * @since 2.2
 */
public class CustomEmailServiceImpl extends EmailServiceImpl
{
    ...
    private static Log logger = LogFactory.getLog(CustomEmailServiceImpl.class);
...
//        }
        ...
        try
        {
            Long nodeId = Long.parseLong(alias);
    ...
    private String getUsername(String from)
    {
        ...
        String query = "TYPE:cm\\:person AND (@cm\\:email:\"" + from + "\" OR @cm\\:companyemail:\"" + from + "\")";
